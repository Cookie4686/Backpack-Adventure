...
public class ItemList {
	...
	static {
		...
		itemMap.put("sword", new Resource(() -> new Weapon("sword", "Sharp!", 10, 1, 1, 2), "sword1.png"));
		//Consumable(String name, String detail, int durability, Effect effect, int costActivate, int width, int height)
		itemMap.put("apple", new Resource(() -> new Consumable("apple", "edible", 1, new Effect(2, EffectType.HEAL), 0, 1, 1), "apple.png"));
