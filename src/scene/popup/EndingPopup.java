...
public class EndingPopup extends Popup {
    private static EndingPopup instance;
    ...
    public static EndingPopup getInstance() {
        if (instance == null) {
            instance = new EndingPopup();
        }
        return instance;
    }
}